...
=== Microsoft SQL Server 本地数据库环境成本分析和迁移规划

BlueXP workload factory for Databases 现在检测、分析并帮助您规划 SQL Server 本地数据库迁移到 Amazon FSx for NetApp ONTAP。您可以使用节省计算器估算在云中运行 SQL Server 本地数据库环境的成本，并查看将本地数据库环境迁移到云的建议。
