...
---
= 分析 NetApp Workload Factory for Databases 中的错误日志
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
NOTE: 如果您的账号管理员已关闭 AI 功能，您将看到一条消息，无法使用 AI 分析功能。请联系您的管理员或 link:https://docs.netapp.com/us-en/workload-setup-admin/manage-genai-features.html["了解人工智能管理"^]。
...
* 你必须 link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["授予_查看、规划和分析_权限"^] 在您的 AWS 账户中，在 Workload Factory 中创建一个新的数据库主机。
* link:https://docs.netapp.com/us-en/workload-databases/register-instance.html["注册资源"^]在工作负载工厂中。
...
** *Oracle 用户权限*
+
以下权限授予对扩展诊断警报的读取访问权限，从而可以从日志中提取错误/跟踪详细信息，以进行 AI 驱动的模式检测和修复： `V$DIAG_ALERT_EXT` 。此权限仅适用于 Oracle 数据库。
